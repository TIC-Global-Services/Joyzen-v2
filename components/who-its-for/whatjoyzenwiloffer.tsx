...
const offerItems = [
  ...
  },
  {
    ...
    customGradients: (
      <>
        ...
        <div className="absolute -bottom-[20%] -left-[20%] w-[80%] h-[50%] opacity-100 md:blur-[80px] blur-[60px] rounded-full transition-transform duration-700 ease-out group-hover:scale-150 group-hover:-translate-y-12 group-hover:translate-x-8" style={{ backgroundColor: "#ddc4df" }} />
        <div className="absolute -bottom-[20%] -right-[20%] w-[80%] h-[50%] opacity-100 md:blur-[80px] blur-[60px] rounded-full transition-transform duration-700 ease-out group-hover:scale-150 group-hover:-translate-y-12 group-hover:-translate-x-8" style={{ backgroundColor: "#b4def7" }} />
      </>
    )
  },
  ...
  },
  {
    ...
    customGradients: (
      <>
       <div className="absolute -bottom-[20%] -left-[20%] w-[40%] h-[50%] opacity-100 md:blur-[80px] blur-[60px] rounded-full transition-transform duration-700 ease-out group-hover:scale-150 group-hover:-translate-y-12 group-hover:translate-x-8" style={{ backgroundColor: "#f8e780" }} />
        <div className="absolute -bottom-[20%] right-[20%] w-[40%] h-[50%] opacity-100 md:blur-[80px] blur-[60px] rounded-full transition-transform duration-700 ease-out group-hover:scale-150 group-hover:-translate-y-12 group-hover:-translate-x-8" style={{ backgroundColor: "#ddc4df" }} />
        <div className="absolute -bottom-[20%] -right-[20%] w-[40%] h-[50%] opacity-100 md:blur-[80px] blur-[60px] rounded-full transition-transform duration-700 ease-out group-hover:scale-150 group-hover:-translate-y-12 group-hover:-translate-x-8" style={{ backgroundColor: "#b4def7" }} />
      </>
    )
  },
  {
  ...
  },
  {
    ...
    customGradients: (
      <>
        <div className="absolute -bottom-[20%] -left-[20%] w-[80%] h-[50%] opacity-100 md:blur-[80px] blur-[60px] rounded-full transition-transform duration-700 ease-out group-hover:scale-150 group-hover:-translate-y-12 group-hover:translate-x-8" style={{ backgroundColor: "#b4def7" }} />
        <div className="absolute -bottom-[20%] -right-[20%] w-[80%] h-[50%] opacity-100 md:blur-[80px] blur-[60px] rounded-full transition-transform duration-700 ease-out group-hover:scale-150 group-hover:-translate-y-12 group-hover:-translate-x-8" style={{ backgroundColor: "#036132" }} />
      </>
    )
  }
];
...
const WhatJoyzenWillOffer = () => {
  ...
  const renderItem = (item: any, index: number) => {
    return (
      <div
        key={`card-${index}`}
        className="w-full h-[380px] md:h-[60dvh] relative group p-8 md:p-10 text-left flex flex-col justify-end transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 overflow-hidden  bg-white border border-[#F0F0F0]"
      >
        ...
        <div className="relative z-20">
          ...
          <p className="text-[#555555] text-sm leading-relaxed font-medium transition-transform duration-500 group-hover:-translate-y-1">
            {item.desc}
          </p>
        </div>
      </div>
